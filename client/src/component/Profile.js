...
<Avatar aria-label="recipe" className={classes.avatar} src={context.authUser==null? profileInfo.proPic : context.profile.proPic} style = {{position:"absolute", width:"200px", height: "200px", left:"25%", top:"-20%"}}/>
  <CardMedia
  ...
  <Typography variant="subtitle1" color="subtitle1" component="p" style={{ fontStyle: "italic",fontSize:"30px", position:"absolute", top:"100px", left:"30%"}}>
      {context.authUser==null? profileInfo.name+ ` ` +profileInfo.surname  : context.profile.name + ` ` + context.profile.surname}
  </Typography>
  ...
  <CardContent>
    <Typography variant="subtitle1" color="subtitle1" component="p" style={{ fontStyle: "italic", position:"absolute", top :"170px", right: "25%"}}>
      {context.authUser==null? `bio:`+ profileInfo.bio : `bio:` + context.profile.bio}
    </Typography>
  </CardContent>
</Card>
</Container>
